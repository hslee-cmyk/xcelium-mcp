"""SimVision orchestration operations for xcelium-mcp.

Extracted from tools/simvision.py (F-039 structural split).
Contains: open_database, start_simvision, setup_waveform, live_start,
reload_waveform, compare_csv_diff, compare_simvision, _load_rows.
"""
...
async def compare_csv_diff(
    ...
    rows_b = await asyncio.to_thread(_load_rows, csv_b)
    rows_a = await asyncio.to_thread(_load_rows, csv_a)
